  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-white">
      ...
      <h1 className="text-2xl font-bold mb-6 text-center">My Profile</h1>
        ...
        <h1 className="text-3xl font-bold mb-4">Eamil: {user.email} </h1>
        ...
        {/* <Link href="/">
        <button className="mt-8 px-6 py-3 bg-white text-black rounded-lg hover:bg-white transition-colors">
          Back to Home
        </button>
      </Link> */}
      </div>
